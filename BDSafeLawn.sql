...
ALTER TABLE DadosSensor MODIFY COLUMN dtCaptura DATETIME;

UPDATE dadosSensor SET dtCaptura = '09:00:00' WHERE idCaptura = 994;
...
SELECT * FROM usuario WHERE emailUsuario = 'joao.alvares@empresa1.com.br' AND senhaUsuario = '123456';

INSERT INTO dadosSensor VALUES
(null, '23-09-2005', 20, 1, 1),
(null, '23-09-2005', 30, 1, 1),
(null, '23-09-2005', 40, 1, 1),
(null, '23-09-2005', 20, 1, 1),
(null, '23-09-2005', 20, 1, 1),
(null, '23-09-2005', 20, 1, 1),
(null, '23-09-2005', 20, 1, 1),
...
INSERT INTO dadosSensor VALUES 
	(null, '2023-05-16 12:00:00', 20, 1, 1),
	(null, '2023-05-16 14:00:00', 50, 1, 1),
	(null, '2023-05-16 15:00:00', 60, 1, 1),
	(null, '2023-05-16 19:00:00', 10, 1, 1);
SELECT * FROM Sensor;
SELECT * FROM dadosSensor;


INSERT INTO dadosSensor VALUES (NULL, '2023-05-16', 20, (SELECT idSensor FROM sensor WHERE idSensor = 1), 1);

SELECT * FROM dadosSensor WHERE fkSensor = 1;
-- cadastro 
